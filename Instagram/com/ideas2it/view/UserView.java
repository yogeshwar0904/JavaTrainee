...
import com.ideas2it.constant.ConstantValue;
...
public class UserView {
    ...
    private StringBuilder userMessage = new StringBuilder();
    ...
    public void userInput() {
        ...
        switch (choice) {
        case ConstantValue.ADDUSER:
            addUser();
            break;

        case ConstantValue.REMOVEUSER:
            removeUser();
            break;

        case ConstantValue.DISPLAYUSER:
            displayUser();
            break;

        case ConstantValue.UPDATEUSER:
            updateUser();
            break;
